    ...
    <>
      <div className="w-full h-[100px] mt-8">
        <Slider className='m-0' {...carouselSettings}>
          <div><img src="/images/advertise-here.png" alt="Carousel Item" className="h-[90px] mx-auto" /></div>
          <div><img src="/images/logo.png" alt="Carousel Item" className="h-[70px] mx-auto" /></div>
          <div><img src="/images/advertise-here.png" alt="Carousel Item" className="h-[90px] mx-auto" /></div>
          <div><img src="/images/logo.png" alt="Carousel Item" className="h-[70px] mx-auto" /></div>
        </Slider>
      </div>
