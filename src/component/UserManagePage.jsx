...
import { Modal, Button, Spinner, Table, Badge } from "flowbite-react";
...
export function UserManagePage() {
  ...
  const fetchBusinesses = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.REACT_APP_API_URL}/api/user-businesses/`,
        {
          params: {
            q: "verified",
          },
  ...
  const handleUpdateBusiness = async () => {
    ...
    const { ceoImg, logo, ...data } = editingBusiness;
    ...
    try {
      const response = await axios.put(
        `${import.meta.env.REACT_APP_API_URL}/api/edit-business/${
          editingBusiness.id
        }/`,
        formData,
        {
      ...
      setBusinesses((prev) =>
        prev.map((b) => (b.id === editingBusiness.id ? editingBusiness : b))
      );
      showToast(
        "success",
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.REACT_APP_API_URL}/api/delete-business/`,
        { email: confirmDelete },
        {
      ...
      showToast(
        "success",
        response?.data?.message || "Business deleted successfully"
      );
    } catch (err) {
  ...
  return (
    <div className="p-3">
                ...
                <Table.Row key={index} className="bg-white">
                  ...
                  <Table.Cell className="text-center">
                    <div className="flex items-center justify-center space-x-4">
                      ...
                      <FaTrash
                        onClick={() => handleDeleteClick(business.email)}
      ...
      {confirmDelete && (
        ...
        >
          ...
          <Modal.Footer className="justify-end">
            <Button color="light" onClick={() => setConfirmDelete(null)}>
              Cancel
            </Button>
            <Button
              color="failure"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-center p-4 rounded-lg border border-gray-200 shadow-sm bg-gray-50">
              ...
              <div>
                ...
                <p className="text-gray-800">
                  {viewBusiness.localgovernment || "N/A"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center p-4 rounded-lg border border-gray-200 shadow-sm bg-gray-50">
              ...
              <div>
                ...
                <p className="text-gray-800">
                  {viewBusiness.whatsappnumber || "N/A"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center p-4 rounded-lg border border-gray-200 shadow-sm bg-gray-50">
              ...
              <div>
                ...
                <p className="text-gray-800">
                  {viewBusiness.staffstrength || "N/A"}
                </p>
              </div>
            </div>
      ...
      <EditBusinessModal
        ...
        details={editingBusiness}
        isViewing={editMode}
        toggleMode={() => {
          if (!editMode) {
            setEditMode(true);
            setEditingBusiness(businessDetails);
          } else {
            setEditMode(false);
          }
        }}
